 ...
 return (
  <>
   <div className="min-w-screen min-h-screen bg-blue-100 flex items-center p-5 lg:p-20 overflow-hidden relative">
    <div className="flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-center justify-center">
     <div className="w-full md:w-1/2">
      <div className="mb-10 lg:mb-20">
       <svg id="logoipsum" xmlns="http://www.w3.org/2000/svg" viewBox="15 30 147.778 40" className="w-48 mx-auto">
        <path
        ...
        />
        <path
         d="M152,50.03v6.078h-2.97V50.287c0-.99-.475-1.623-1.425-1.623-.99,0-1.545.693-1.545,2.029v5.416h-2.971v-.073c0-.792-.109-1.722-1.158-1.722s-1.425.77-1.425,1.871v4.885h-2.97V46.209h2.97v.892c.712-1.375,1.629-2.029,3.076-2.029a4.628,4.628,0,0,1,2.79.945V46.209Z"
         fill="#0582C1"
        />
       </svg>
       <h2 className="text-3xl font-semibold mb-3">
        Oops! Something went wrong,<span className="block text-5xl"> with status 404.</span>
       </h2>
       <p className="text-gray-600">
        We apologize for the inconvenience {error.statusText || error.message}. It seems there was an error processing your request. Please try again
        later.
       </p>
      </div>
      <a href="/" className="bg-[#052A49] hover:bg-[#0f3b60] text-white font-bold py-2 px-4 rounded-full inline-flex items-center">
