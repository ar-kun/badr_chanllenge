       ...
       <div className="flex items-center w-full justify-between">
        <div className="flex-shrink-0">
         <p className="text-xl font-bold text-sky-950">
          <span>
           <i className="fa-solid fa-circle text-amber-500 text-[0.70rem] me-1"></i>
          </span>
          MyBrand
         </p>
        </div>
           ...
           <div>
            ...
            >
             ...
             <img
              ...
              alt=""
             />
             <p className="mx-2 text-md font-semibold">Cooper Rossey</p>
     ...
     <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} md:hidden`} id="mobile-menu">
      ...
      <div className="border-t border-gray-700 pb-3 pt-4">
       <div className="flex items-center px-5">
        ...
        <div className="ml-3">
         <div className="text-base font-medium leading-none text-gray-700">Tom Cook</div>
